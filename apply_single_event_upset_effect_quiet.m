function [updated_graph, high_risk_satellites] = apply_single_event_upset_effect_quiet(graph_matrix, sat_lat_lon, seu_probability)
% 应用单粒子翻转(SEU)效应对卫星拓扑的影响（静默版本，无输出信息）
